...
from dataset import DenseMammo_density, MultiImagesDataset, get_fold
...
def load_data(args):
    ...
    data = DenseMammo_density(root = args.data_path)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--data-path", default="/dataset/Mammogram/DenseMammo_PNG", type=str, help="dataset path")
