...
from dataset import BreastMammo_density, MultiImagesDataset, get_fold
...
def load_data(args):
    ...
    data = BreastMammo_density(root = args.data_path)
    train_data, test_data = get_fold(data, fold = args.fold)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--data-path", default="/dataset/Mammogram/BreastMammo_PNG", type=str, help="dataset path")
